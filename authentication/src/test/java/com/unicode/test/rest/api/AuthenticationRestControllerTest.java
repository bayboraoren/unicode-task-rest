...
import com.unicode.test.rest.security.JwtUser;
import com.unicode.test.rest.security.JwtUserFactory;
import com.unicode.test.rest.security.model.Authority;
import com.unicode.test.rest.security.model.AuthorityName;
import com.unicode.test.rest.security.model.User;
import com.unicode.test.rest.security.request.JwtAuthenticationRequest;
import com.unicode.test.rest.security.util.JwtTokenUtil;
...
public class AuthenticationRestControllerTest {
    ...
    public void successfulAuthenticationWithAnonymousUser() throws Exception {
        ...
        this.mvc.perform(post("/auth")
                ...
                .content(new ObjectMapper().writeValueAsString(jwtAuthenticationRequest))).andDo(print())
